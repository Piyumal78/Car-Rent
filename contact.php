        ...
        <div class="container">
            <div class="contact-info-grid">
                ...
                <div class="contact-card">
                    ...
                    <div class="contact-details">
                        <strong>driveeasy@gmail.com</strong>
                ...
                <div class="contact-card">
                    ...
                    <div class="contact-details">
                        ...
                        <span>Colombo, bambalapitiya 12345</span>
                    </div>
                </div>
                <div class="contact-card">
                    <div class="contact-icon">
        ...
        <div class="container">
            <div class="contact-content">
                <div class="contact-form-container">
                    ...
                    <form id="contactForm" class="contact-form" action="contacts.php" method="POST">
                        <div class="form-row">
            ...
            <div class="locations-grid">
                <div class="location-card">
                    ...
                    <div class="location-info">
                        <p><i class="fas fa-map-marker-alt"></i> 123 Main Street, Colombo 7</p>
                        <p><i class="fas fa-phone"></i> 081-5678792</p>
                ...
                <div class="location-card">
                    <h3>Shopping Mall</h3>
                    <div class="location-info">
                        <p><i class="fas fa-map-marker-alt"></i> Colombo Center Mall, Level B1</p>
                        <p><i class="fas fa-phone"></i> 081-5678792</p>
